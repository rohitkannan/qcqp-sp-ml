...
# ADDED
function fasg_(n::FInt, x::Array{Float64}, mm::FInt, 
		f::Array{Float64}, g::Array{Float64}, eps_val::Float64, ierr::Array{FInt},
		cbi::CI) where {FInt, CI}
	...
	# cbi.fasg(n, x, mm, f, g)
	# ADDED
	cbi.fasg(n, x, mm, f, g, eps_val, ierr)
...
function unsafe_FASGCallback(
	...
	# ADDED
	ierr = unsafe_wrap(Array, ierr_, (1, ), own=false)
	user = unsafe_wrap(Array, user_, (1,), own=false)
	fasg_(n, x, mm, f, g, user[1], ierr, cbi)
