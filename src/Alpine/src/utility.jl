...
function eval_opt_gap(m::Optimizer, lower_bound::Number, upper_bound::Number)
   ...
   # ADDED
   elseif lower_bound > tol*abs(upper_bound) + upper_bound
      println("ERROR:  lower bound: ", lower_bound, "  upper bound: ", upper_bound)
...
function _get_solver_name(m::Optimizer, key::Symbol, override::String)
   ...
   for name in ("Ipopt", "Gurobi", "CPLEX", "Juniper", "Knitro")
