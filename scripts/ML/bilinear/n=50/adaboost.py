...
for inst in range(numInstances):
	features_file = base_dir + 'results/bilinear/n=50/ml_features/qcqp_v50_b250_s100_' + str(inst+1) + '_features.json'
...
for fold in range(numFolds):
	...
	for i in rand_perm[testing_set]:
		...
		part_file = 'ab_predicted_part_points/qcqp_v50_b250_s100_' + str(i+1) + '_ab_pred.json'
