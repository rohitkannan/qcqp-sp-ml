...
for inst in range(numInstances):
	features_file = base_dir + 'results/bilinear/n=20/ml_features/d=4/qcqp_v20_b100_s100_' + str(inst+1) + '_features.json'
...
for fold in range(numFolds):
	...
	for i in rand_perm[testing_set]:
		...
		part_file = 'ab_predicted_part_points/qcqp_v20_b100_s100_' + str(i+1) + '_ab_pred_4pts.json'
