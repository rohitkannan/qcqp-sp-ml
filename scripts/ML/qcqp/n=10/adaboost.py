...
for inst in range(numInstances):
	features_file = base_dir + 'results/qcqp/n=10/ml_features/qcqp_v10_b45_q2_s100_' + str(inst+1) + '_features.json'
...
for i in range(numInstances):
	...
	part_file = 'ab_predicted_part_points/qcqp_v10_b45_q2_s100_' + str(i+1) + '_ab_pred.json'
